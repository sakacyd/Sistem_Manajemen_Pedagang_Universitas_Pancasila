...
### 1. Jurnal Minfo Polgan: Sistem Pemesanan Coffee Shop (2025)
Jurnal ini berfokus pada perancangan sistem informasi pemesanan menu untuk meningkatkan efisiensi operasional dan akurasi pesanan di coffee shop. 
link : https://www.journal.itbriau.ac.id/index.php/dastis/article/view/31

> Metodologi: Menggunakan model Waterfall yang mencakup analisis kebutuhan, perancangan (termasuk use case diagram), implementasi, dan pengujian.  
> Fitur Utama: E-menu, manajemen pesanan, Kitchen Display System (KDS), integrasi pembayaran QRIS, dan pelaporan penjualan.  
> Hasil Penelitian:
    - Efisiensi Waktu: Kecepatan proses pemesanan meningkat sebesar 51,1% (turun dari 4'35" menjadi 2'15").  
...
> Manfaat Mahasiswa: Memudahkan transaksi non-tunai, mempercepat pembayaran, dan membantu pencatatan keuangan harian secara otomatis.  

> Manfaat Pedagang: Meningkatkan daya tarik bagi pembeli mahasiswa dan mempermudah operasional karena tidak perlu menyediakan uang kembalian.  

> Kendala: Masalah sinyal internet yang lemah sering menyebabkan kegagalan transaksi, sehingga pelanggan terpaksa kembali menggunakan uang tunai.  
...
> Metodologi: Sama dengan jurnal pertama, menggunakan model Waterfall untuk memastikan tahapan pengembangan yang terstruktur.  

> Alur Sistem: Pelanggan memindai QR Code di meja, memilih menu digital, dan pesanan otomatis terkirim ke dapur dan kasir.  
...
2. Kira-kira ada berapa banyak variasi menu (makanan dan minuman) yang dijual saat ini? Apakah menu tersebut sering berganti-ganti setiap harinya?

3. Pada jam berapa biasanya terjadi lonjakan pembeli (peak hours) yang paling sibuk?

### Bagian B (Analisis Proses Bisnis)

4. Bisa diceritakan bagaimana proses layanan, misal pemesanan makanan dari awal sampai selesai?

5. Siapa saja yang terlibat dalam proses ini?

6. [Baru] Bagaimana biasanya cara menginformasikan ke pembeli jika ada stok makanan/minuman yang tiba-tiba habis di tengah jam operasional?

### Bagian C (Identifikasi Masalah)

7. Kendala apa saja yang sering muncul dalam menjalankan proses tersebut? (Seperti saat catat pesanan atau stok habis atau kendala lain).

8. Bagaimana cara menangani masalah tersebut sekarang secara manual?

9. Saat kondisi sedang ramai, apakah sering terjadi kendala dalam menghitung total tagihan atau saat mengembalikan uang kembalian?

### Bagian D (Solusi/Kebutuhan Sistem)

10. Jika kita membuat sistem, kira-kira fitur apa yang paling membantu buat masalah tersebut?

11. Siapa saja nanti yang diizinkan untuk mengakses sistem tersebut?

12. Agar sistem dashboard pesanan nanti mudah digunakan saat sedang sibuk melayani, apakah ada preferensi tampilan khusus? (Misalnya: tombol harus besar, atau warna tertentu untuk pesanan baru).

13. Apakah diperlukan fitur rekap otomatis untuk total pendapatan harian di akhir jam tutup warung?
...
## Activity Diagram
Berikut adalah rancangan Activity Diagram yang memvisualisasikan bagian Gambaran Rancangan Sistem Kerja Baru.
...
<img width="158" height="347" alt="Screenshot 2026-06-25 015311" src="https://github.com/user-attachments/assets/94034470-f4c8-46e7-a870-6181603ab2d3" />
